...
const CurvedArrow: React.FC<CurvedArrowProps> = ({children}) => {
  return (
    ...
    <svg style={{position: 'absolute'}} width="250" height="81" viewBox="0 0 536 81" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<ReactCurvedText
      ...
      startOffset={100} // starting position on the curve
